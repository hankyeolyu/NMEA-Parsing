...
if(_nmea_msgs_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED nmea_msgs_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(nmea_msgs_FOUND FALSE)
  elseif(NOT nmea_msgs_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(nmea_msgs_FOUND FALSE)
  endif()
  return()
endif()
set(_nmea_msgs_CONFIG_INCLUDED TRUE)

# output package information
if(NOT nmea_msgs_FIND_QUIETLY)
  message(STATUS "Found nmea_msgs: 0.0.0 (${nmea_msgs_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'nmea_msgs' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${nmea_msgs_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(nmea_msgs_FOUND_AMENT_PACKAGE TRUE)
