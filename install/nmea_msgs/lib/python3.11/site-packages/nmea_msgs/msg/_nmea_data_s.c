...
bool nmea_msgs__msg__nmea_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nmea_msgs.msg._nmea_data.NmeaData", full_classname_dest, 33) == 0);
  }
  nmea_msgs__msg__NmeaData * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of NmeaData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nmea_msgs.msg._nmea_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NmeaData");
